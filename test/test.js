...
[
    {name: 'default', provider: Promise},
    {name: 'bluebird', provider: bluebird.Promise}
].forEach(function(provider) {
    describe('promise-retry provider ' + provider.name, function() {
        beforeEach(function() {
            promiseRetry.setPromiseProvider(provider.provider);
        });
